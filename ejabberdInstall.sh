...
sudo apt-get -t buster-backports install make autogen autoconf gcc git erlang libexpat1 libexpat1-dev libyaml-0-2 erlang zlib1g zlib1g-dev imagemagick openssl libssl1.1 libssl-dev libyaml-dev unzip zip p7zip-full libsqlite3-0 libsqlite3-dev libpam0g libpam0g-dev libpam-modules libpam-modules-bin -y
